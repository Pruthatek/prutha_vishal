...
import SelectYourDomain from './ExpressstackSelectYourDomain'

const Expressstackmain = (props) => {
...
<div className="flex flex-col md:flex-col lg:flex-row lg:justify-between items-center px-8 md:px-16 lg:space-x-16 ">
    <div className="flex flex-col  ">
        ...
        <h2 className="devtext text-[20px] md:text-[40px] from-[#EF32D9] to-[#EF32D9] not-italic font-bold leading-[normal]  capitalize py-2">Express Js Stack Developer</h2>
...
export default Expressstackmain;
