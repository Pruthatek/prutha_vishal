export const teamMembersData = [
	...
	},
	{
		...
		Experties: "",
		Learninig: "Focuses on Market Research and Industry Trends.",
	},
	{
	...
	},
	{
		...
		Learninig: "RESTful API Development, Database Modeling.",
	},
	{
		style: "shadow-[#98D640]",
		gradientBorder: "from-[#D400A5] via-[#1F7ECB] to-[#2ED6E3]",
		...
		name: "Ansh Modi",
		lastName: "Modi",
		role: "Cross Platform &  Front End Developer",
		experience: "2+ years of experience",
		Skills:
			"Expertise in developing cross-platform web and mobile applications using technologies such as React Native and Flutter Proficient in front-end development with HTML, CSS, and JavaScript frameworks such as React and Angular Experience with version control systems such as Git.",
		Experties:
			"Hybrid App Expertise, Seamless User Experiences, Code Portability, Platform Agnostic Development, Native Integration.",
		Learninig: "Python, Ruby, Cloud Computing.",
	},
	{
		style: "shadow-[#57C3AD]",
		gradientBorder: "from-[#7A4199] via-[#AC3F6D] to-[#E93E3A]",
		...
		experience: "2+ years of experience",
		Skills:
			"Designs and develops robust and scalable server-side applications Expertise in programming languages such as Java, Python, and Ruby Experience with database technologies such as MySQL and MongoDB.",
		Experties:
			"Server-Side Programming, Database Management, API Development, Performance Optimization, Security Implementation.",
		Learninig: "DevOps methodologies, blockchain, ASP.NET, Golang.",
	},
	{
		style: "shadow-[#2D1449]",
		gradientBorder: "from-[#D400A5] via-[#1F7ECB] to-[#2ED6E3]",
		...
		experience: "2+ years of experience",
		Skills:
			"Expertise in front-end languages such as HTML, CSS, and JavaScript Familiarity with front-end frameworks such as React, Angular, and Vue.js Ability to create responsive and user-friendly interfaces.",
		Experties:
			"HTML5/CSS3 Mastery, JavaScript Proficiency, React/Vue/Angular Expertise, TypeScript.",
		Learninig:
	...
	// },
	{
		...
		Learninig: "Performance Monitoring and Debugging.",
	},
	{
		style: "shadow-[#0000FF]",
		gradientBorder: "from-[#7A4199] via-[#AC3F6D] to-[#E93E3A]",
		...
		Learninig: "Web Performance Metrics, Testing Frameworks.",
	},
	{
		style: "shadow-[#C9F6FF]",
		gradientBorder: "from-[#F05225] to-[#EEA820]",
	...
	},
	{
		...
		Learninig: "Security Testing, API Testing.",
	},
];
