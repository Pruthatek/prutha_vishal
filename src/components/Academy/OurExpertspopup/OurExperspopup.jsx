...
const OurExperspopup = ({ data }) => {
  return (
    ...
    <div className={"bg-gradient-to-r p-[3px] rounded-xl lg:w-[80%] w-[90%] h-fit max-h-[80vh] relative overflow-y-scroll md:overflow-visible " + data.gradientBorder}>
        <div className=" flex flex-col lg:flex-row dark:bg-[#101010] backdrop-opacity-70 backdrop-filter backdrop-blur-[3px] bg-[#afafaf1a]/100  rounded-lg lg:p-5 py-2">
            {/* Close */}
