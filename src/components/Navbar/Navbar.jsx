    ...
    <div className="bg-transparent">
      ...
      <nav className="flex items-center justify-between px-10 py-5">
        ...
        <div className="flex items-center justify-between gap-x-5">
          ...
          {/* Contact */}
          <Link to="/contact" className="cursor-pointer flex flex-row items-center justify-between gap-x-4 bg-gradient-to-r from-[#F05225] to-[#EEA820] rounded-lg py-1.5 px-3 drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
