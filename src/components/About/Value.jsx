...
const Value = () => {
  return (
    <div className="flex flex-col items-center my-10 px-20">
      <h2 className="text-[25px]">Our Values</h2>
      <p className="text-[16px] text-center lg:w-[65%]">
        ...
        <div className="flex flex-col gap-y-5">
          <div className="flex flex-row items-center gap-x-10">
            ...
            <div className="flex flex-col">
              <h2 className="text-[#FF63F9] font-semibold  text-[25px]">
                Quality Driven
              </h2>
          ...
          <div className="flex flex-row items-center gap-x-10">
            ...
            <div className="flex flex-col">
              <h2 className="text-[#F05225]  font-semibold   text-[25px]">
          ...
          <div className="flex flex-row items-center gap-x-10">
            ...
            <div className="flex flex-col">
              <h2 className="text-[#3D7800] font-semibold text-[25px] ">
                Innovation
              </h2>
              <p className="text-[12px] md:text-[16px]">
                We work to deliver the best solution, and thus quality is our
          ...
          <div className="flex flex-row items-center gap-x-10">
            ...
            <div className="flex flex-col">
              <h2 className="text-[#FF63F9] text-[25px]  font-semibold">
                Creativity
              </h2>
              <p className="text-[12px] md:text-[16px]">
                We work to deliver the best solution, and thus quality is our
