    ...
    <div className="flex flex-col lg:items-center justify-center">
      ...
      <div className="flex flex-col lg:flex-row items-center lg:gap-x-20">
        ...
        <div className="flex flex-col items-start w-full">
          <div className="bg-gradient-to-r from-[#F05225] to-[#EEA820] rounded-full py-1.5 px-8">
        ...
        <div className="flex flex-col items-start w-full mt-5 lg:my-0">
          <div className="bg-gradient-to-r from-[#0038FF] to-[#3A86FF] rounded-full py-1.5 px-8 text-center">
            <p className="uppercase font-semibold text-description">
              SALES & MARKETING
            </p>
          </div>
        ...
        {/* SEA */}
        <div className="flex flex-col items-start w-full mt-5 lg:my-0">
          <div className="bg-gradient-to-r from-[#0DA1DA] to-[#5DB98E] rounded-full py-1.5 px-8 text-center">
            <p className="uppercase font-semibold text-description">
              SALES & MARKETING
            </p>
          </div>
        ...
        {/* Australia */}
        <div className="flex flex-col items-start w-full mt-5 lg:my-0">
          <div className="bg-gradient-to-r from-[#E10E8C] to-[#520C43] rounded-full py-1.5 px-8 text-center">
            <p className="uppercase font-semibold text-description">
              SALES & MARKETING
            </p>
          </div>
